package sudip.springframework.spring5webapp.bootstrap;

import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import sudip.springframework.spring5webapp.model.Author;
import sudip.springframework.spring5webapp.model.Book;
...
import sudip.springframework.spring5webapp.repositories.PublisherRepository;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void initData(){
        ...
        publisher.setAddress("Jayanagar Bangalore");
        publisher.setName("Axis PUblication");
